...
UserModel nitinchauhan = UserModel(
    assetName: 'assets/sontung.png', userName: 'Sơn Tùng');
UserModel utsavKamboj = UserModel(
    assetName: 'assets/mytam.png', userName: 'Mỹ Tâm');
UserModel bawaraa =
    UserModel(assetName: 'assets/noophuocthinh.png', userName: 'Noo Phước Thịnh');
UserModel karanAujala = UserModel(
    assetName: 'assets/ducphuc.png', userName: 'Đức Phúc');
UserModel panchmighavri = UserModel(
    assetName: 'assets/erik.png', userName: 'Erik');
UserModel ezsnippet =
    UserModel(assetName: 'assets/vanmaihuong.png', userName: 'Văn Mai Hương');
